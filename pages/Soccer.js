...
export default function Kontakt() {
    ...
    return (
        <>
            <Head>
                <title>Kontakt - Treten Sie mit Klimanrw in Kontakt für klimafreundliche Lösungen</title>
                <meta name="description" content="Kontaktieren Sie uns für eine persönliche Beratung rund um das Thema Klimaanlagen. Unsere Adresse lautet Huttropstraße 60, 45138 Essen (Germany). Tel: 02369 4049939, Email: Info@klimanrw.de" />
                <meta name="keywords" content="Kontakt, Klimaanlagen, Beratung, Adresse, Telefon, Email, Klimanrw, Essen, Deutschland" />
            </Head>
            ...
            <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:py-48 lg:px-8">
                    <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                        ...
                        <h2 className="text-3xl font-bold tracking-tight text-gray-900">Hallo Kollegen von VFL Resse 08!</h2>
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            Als treue Fans des VFL Resse 08 erhalten Sie 10% Nachlass auf die Montage einer Klimaanlage bei uns!
                        </p>
...
/>
                        ...
                        <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
                            <div className="flex gap-x-4">
                                ...
                                <dd>
                                    <a href="tel:015738350053" title="Klima-Nrw-Telefon" className="hover:text-gray-900" >
                                        015738350053
                                    </a>
                                </dd>
                            </div>
                            <div className="flex gap-x-4">
                                ...
                                <dd>
                                    <a href="tel:023694049939" title="Klima-Nrw-Telefon" className="hover:text-gray-900" >
                                        02369 4049939
                                    </a>
                                </dd>
                            </div>
                            <div className="flex gap-x-4">
                                ...
                                <dd>
                                    <a href="mailto:Info@klimanrw.de" title="Klima-Nrw-Email" className="hover:text-gray-900" >
                                        Info@klimanrw.de
                                    </a>
                                </dd>
                            </div>
                ...
                <form onSubmit={handleSubmit} className="px-6 pb-24 pt-20 sm:pb-32 lg:py-48 lg:px-8">
                  ...
                  />
                        ...
                        <div className="mt-8 flex justify-end">
                            {successMessage && (
                                <p className="text-green-600 mr-4 mt-2">
                                    {successMessage}
                                </p>
                            )}
                            <button
