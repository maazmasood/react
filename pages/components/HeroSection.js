  ...
  return (
    <div>
      <div className="relative flex">
        <div className="bg-gray-50 absolute lg:inset-y-0 lg:right-0 top-0 h-full w-full main_screen">
          <Image
        ...
        <div className="mx-auto max-w-7xl flex justify-end items-center mt-16 md:mt-0">
          <div className="md:w-1/2 w-full p-6">
            <div className="relative z-20 pt-52 lg:pt-14 h-screen lg:w-full lg:max-w-2xl">
              <div className="relative  px-6 sm:py-40 lg:py-56 lg:px-8 lg:pr-0 sm:mb-2 sm:mt-2 lg:mt-6">
                <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                  <div className="hidden sm:mb-10 sm:block">
                    ...
                    >
                      Bis zum 30 April noch von unserem Winterangebot
                      Profitieren{" "}
          ...
          <div className="w-1/2 hidden md:block z-20 mt-32 flex justify-center items-center md:ml-20">
            <div className="m-12 rounded-lg shadow-lg max-w-3xl w-full md:ml-12">
