    ...
    return (
        <div>
            <Head>
                ...
                <meta name="keywords" content="Wartung, Pflege, Wärmepumpen, Klimaanlagen, Geschäftskunden, Dorsten" />
                <title>Wartung und Pflege von Wärmepumpen und Klimaanlagen für Geschäftskunden in Dorsten | Unternehmensname</title>
                <link rel="canonical" href="https://klimanrw.de/Waermepumpen" />
                <meta property="og:title" content="Wartung und Pflege von Wärmepumpen und Klimaanlagen für Geschäftskunden in Dorsten | Unternehmensname" />
                <meta property="og:description" content="Unser Unternehmen in Dorsten bietet Geschäftskunden planmäßige Wartungs- und Pflegedienste für ihre Wärmepumpen und Klimaanlagen an. Wir verwenden hochwertige Materialien und Techniken, um sicherzustellen, dass Ihre Geräte optimal funktionieren. Kontaktieren Sie uns für maßgeschneiderte Lösungen für Ihr Unternehmen." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://klimanrw.de/Waermepumpen" />
                <meta property="og:image" content="https://klimanrw.de/Klima-Nrw-Brauchwasserpumpe.webp" />
                <meta property="og:image:alt" content="Brauchwasserpumpe" />
                <meta name="twitter:title" content="Wartung und Pflege von Wärmepumpen und Klimaanlagen für Geschäftskunden in Dorsten | Unternehmensname" />
                <meta name="twitter:description" content="Unser Unternehmen in Dorsten bietet Geschäftskunden planmäßige Wartungs- und Pflegedienste für ihre Wärmepumpen und Klimaanlagen an. Wir verwenden hochwertige Materialien und Techniken, um sicherzustellen, dass Ihre Geräte optimal funktionieren. Kontaktieren Sie uns für maßgeschneiderte Lösungen für Ihr Unternehmen." />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:image" content="https://klimanrw.de/Klima-Nrw-Brauchwasserpumpe.webp" />
                <meta name="twitter:image:alt" content="Brauchwasserpumpe" />
            </Head>
                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="lg:pr-4">
                        <div className="lg:max-w-lg">
                            ...
                            <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Wärmepumpen</h1>
